...
const Hero = () => {
  ...
  return (
    <main className="relative">
          ...
          >
            ...
            {auth?.user && (
              <div className="mt-6 flex justify-center md:justify-start">
                <span className="text-white text-2xl">👤 {auth.user.name}</span>
              </div>
            )}
          </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black to-gray-900 opacity-100 pointer-events-none z-[-1]"></div>
    </main>
  );
}
